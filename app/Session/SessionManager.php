...
class SessionManager extends Manager
{
    ...
    {
        return $this->buildSession(new  \Illuminate\Session\ArraySessionHandler(
    ...
    {
        return $this->buildSession(new  \Illuminate\Session\CookieSessionHandler(
    ...
    protected function createNativeDriver()
    {
        ...
        return $this->buildSession(new  \Illuminate\Session\FileSessionHandler(
    ...
    protected function createCacheHandler($driver)
    {
        ...
        return new  \Illuminate\Session\CacheBasedSessionHandler(
    ...
    protected function buildSession($handler)
    {
        return $this->config->get('session.encrypt')
            ...
            : new \Illuminate\Session\Store($this->config->get('session.cookie'), $handler);
    }
    ...
    {
        return new \Illuminate\Session\EncryptedStore(
